...
window.AILAB = {
 ...
 "cards": [
  ...
  },
  {
   ...
   "nextGoal": "실험1′·2·3 종결(축 분리 양방향 확증). 다음은 실험4(신호품질·기권 — 유일한 인과 실험), 이어서 실험10(유도 ablation) — 실험3이 남긴 PTB-XL lead II 파이프라인에 유도 슬라이스만 갈아끼우면 되고, MI·HYP로 뺀 7,300건(33%)을 되찾는 실험이다. 판단신호 미검정 5개의 시험장은 ailab-2026-0018 참조",
   "status": "active",
   "sections": {
