...
window.AILAB = {
 ...
 "cards": [
  ...
  },
  {
   ...
   "nextGoal": "실험1′·2·3·4 종결. 실험4 결론: 기권 신호는 클래스마다 달라야 한다(확률은 N에서 AUC 0.878인데 S에서 0.184로 역전, 품질은 그 반대) — 예측 클래스 조건부 기권 규칙 검정을 큐에 추가. 다음은 실험10(유도 ablation, 노트북 준비완료 — 실험9 lead-agnostic 동시 수행) — 실험3이 남긴 PTB-XL lead II 파이프라인에 유도 슬라이스만 갈아끼우면 되고, MI·HYP로 뺀 7,300건(33%)을 되찾는 실험이다. 판단신호 미검정 5개의 시험장은 ailab-2026-0018 참조",
   "status": "active",
   "sections": {
