...
window.AILAB = {
 ...
 "cards": [
  ...
  },
  {
   ...
   "nextGoal": "실험1′ 본 실행 — QUICK 파이프라인 검증 완료(114환자). QUICK=False(900환자)로 돌려 이소성 보유 테스트 환자를 14명 → 70명+ 로 올려야 B3R−B3 판정 가능. 노트북 notebooks/exp1_icentia_rhythm_scale.ipynb",
   "status": "active",
   "sections": {
