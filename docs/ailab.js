...
window.AILAB = {
 ...
 "cards": [
  ...
  },
  {
   ...
   "nextGoal": "실험1′·2·3·4 종결. 실험4에서 확률(softmax) 기권이 품질 기권을 이겨 게이밍 여부를 CELL 6.5로 판정중. 다음은 실험10(유도 ablation, 노트북 준비완료 — 실험9 lead-agnostic 동시 수행) — 실험3이 남긴 PTB-XL lead II 파이프라인에 유도 슬라이스만 갈아끼우면 되고, MI·HYP로 뺀 7,300건(33%)을 되찾는 실험이다. 판단신호 미검정 5개의 시험장은 ailab-2026-0018 참조",
   "status": "active",
   "sections": {
