...
window.USMLE_QUESTIONS = [
 ...
 },
 {
  ...
  "type": "Fat Embolism Syndrome (Mechanism of Petechial Rash after Long Bone Fracture)",
  "difficulty": 4,
  "created": "2026-07-23",
  "vignette": "A 19-year-old man develops confusion, dyspnea, and a petechial rash over the chest and axillae 36 hours after surgical fixation of a closed femoral shaft fracture sustained in a motor vehicle collision. He was neurologically intact and hemodynamically stable immediately after the injury. Vital signs and laboratory studies obtained now are shown. Chest imaging shows diffuse bilateral opacities.",
  "question": "Which of the following mechanisms best explains this patient's petechial rash?",
  "options": [
   "Occlusion of dermal capillaries by marrow-derived fat globules with local endothelial injury from free fatty acids",
   "Immune-mediated platelet destruction from fracture-associated antiplatelet antibodies",
   "Disseminated intravascular coagulation from gram-negative sepsis",
   "Vitamin C deficiency causing impaired collagen cross-linking in vessel walls",
   "Direct bacterial invasion of dermal vessels from an open wound"
  ],
  "answer": 1,
  "explanationText": "- 정답근거: 장골 골절 후 24–72시간의 잠복기를 거쳐 호흡곤란·의식변화·점상출혈이 나타나는 전형적 지방색전증후군이다. 골수에서 유리된 지방구가 모세혈관을 기계적으로 막고, 리파아제에 의해 유리지방산으로 분해되면서 내피세포를 직접 손상시켜 국소 출혈(점상출혈)과 혈소판 소모, 저칼슘혈증을 일으킨다.\n- 오답감별:\n  - (B) 골절 자체가 항혈소판 항체를 유발한다는 기전은 확립되어 있지 않으며, 이 환자의 혈소판감소는 면역매개가 아니라 유리지방산에 의한 소모성 기전이다.\n  - (C) 감염 징후(발열·백혈구증가)가 경미하고 그람음성패혈증을 시사하는 임상경과가 아니며, 시점·병력(장골 골절 후 잠복기)이 지방색전증후군에 훨씬 부합한다.\n  - (D) 비타민C 결핍(괴혈병)은 만성 경과의 문제이며 급성 외상 후 36시간 만에 발생하는 소견을 설명하지 못한다.\n  - (E) 병력상 개방창이나 국소 감염의 증거가 없고, 점상출혈의 분포(흉부·액와부)와 전신 소견(저산소혈증·신경학적 변화)이 세균 직접 침범보다 색전 기전에 부합한다.\n- 임상핵심: 장골 골절 후 24–72시간에 호흡곤란·의식변화·점상출혈의 3징후가 나타나면 지방색전증후군을 의심하고, 혈소판감소·저칼슘혈증 동반 여부로 뒷받침한다.\n- 출처: Robbins and Cotran Pathologic Basis of Disease; Rosen's Emergency Medicine.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "장골 골절 후 24–72시간의 잠복기를 거쳐 호흡곤란·의식변화·점상출혈이 나타나는 전형적 지방색전증후군이다. 골수에서 유리된 지방구가 모세혈관을 기계적으로 막고, 리파아제에 의해 유리지방산으로 분해되면서 내피세포를 직접 손상시켜 국소 출혈(점상출혈)과 혈소판 소모, 저칼슘혈증을 일으킨다."
   },
   {
    "k": "오답감별",
    "v": "(B) 골절 자체가 항혈소판 항체를 유발한다는 기전은 확립되어 있지 않으며, 이 환자의 혈소판감소는 면역매개가 아니라 유리지방산에 의한 소모성 기전이다.\n(C) 감염 징후(발열·백혈구증가)가 경미하고 그람음성패혈증을 시사하는 임상경과가 아니며, 시점·병력(장골 골절 후 잠복기)이 지방색전증후군에 훨씬 부합한다.\n(D) 비타민C 결핍(괴혈병)은 만성 경과의 문제이며 급성 외상 후 36시간 만에 발생하는 소견을 설명하지 못한다.\n(E) 병력상 개방창이나 국소 감염의 증거가 없고, 점상출혈의 분포(흉부·액와부)와 전신 소견(저산소혈증·신경학적 변화)이 세균 직접 침범보다 색전 기전에 부합한다."
   },
   {
    "k": "임상핵심",
    "v": "장골 골절 후 24–72시간에 호흡곤란·의식변화·점상출혈의 3징후가 나타나면 지방색전증후군을 의심하고, 혈소판감소·저칼슘혈증 동반 여부로 뒷받침한다."
   },
   {
    "k": "출처",
    "v": "Robbins and Cotran Pathologic Basis of Disease; Rosen's Emergency Medicine."
   }
  ],
 ...
 },
 {
  ...
  "difficulty": 4,
  "created": "2026-07-28",
  "vignette": "A 58-year-old woman receiving high-dose intravenous methotrexate for primary CNS lymphoma develops oral mucositis and pancytopenia on hospital day 3. She is started on a rescue agent per protocol. Vital signs and laboratory studies are shown; renal function remains normal.",
  "question": "Which of the following best explains the mechanism by which the rescue therapy prevents further toxicity in this patient?",
  "options": [
   "It competitively displaces methotrexate from dihydrofolate reductase, restoring enzyme activity",
   "It provides a reduced folate cofactor that bypasses the blocked dihydrofolate reductase step, restoring one-carbon transfer reactions",
   "It inhibits renal organic anion transporters, reducing tubular reabsorption of methotrexate",
   "It alkalinizes the urine, increasing methotrexate solubility and enhancing renal clearance",
   "It induces hepatic cytochrome enzymes that accelerate methotrexate metabolism to inactive metabolites"
  ],
  "answer": 2,
  "explanationText": "- 정답근거: 류코보린(폴린산)은 이미 환원된 형태의 엽산으로, 디하이드로엽산환원효소(DHFR)의 작용 없이도 바로 활성 보조인자(테트라하이드로엽산)로 쓰일 수 있다. 따라서 메토트렉세이트가 DHFR을 계속 억제하는 상황에서도 정상 세포의 티미딜산·퓨린 합성에 필요한 1탄소 전달 반응을 우회적으로 복구시켜 준다 — 이는 효소 자리를 두고 경쟁하는 것이 아니라 대사 경로를 우회하는 '구제(rescue)' 기전이다.\n- 오답감별:\n  - A: 류코보린은 DHFR 자리에서 메토트렉세이트와 직접 경쟁해 효소를 되살리는 것이 아니라, DHFR을 거치지 않고 하류 대사산물을 바로 공급하는 우회 기전이다.\n  - C: 유기음이온수송체 억제는 신장 배설 관련 약물상호작용(예: NSAID·페니실린류) 기전이며, 류코보린 구제의 작용기전이 아니다.\n  - D: 소변 알칼리화는 메토트렉세이트 결정 형성을 막아 신독성을 예방하는 별도의 예방 전략(수액·중탄산나트륨)이며, 류코보린의 세포 내 구제 기전과는 무관하다.\n  - E: 류코보린은 간 사이토크롬 효소를 유도해 메토트렉세이트 대사를 가속시키지 않는다. 메토트렉세이트는 주로 신장으로 미변화 배설된다.\n- 임상핵심: 고용량 MTX 독성 시 류코보린은 DHFR 억제를 '되돌리는' 것이 아니라 환원엽산을 직접 공급해 우회한다 — 예방(수액·소변알칼리화)과 구제(류코보린)는 서로 다른 전략임을 구분한다.\n- 출처: UpToDate — Pharmacology of high-dose methotrexate and leucovorin rescue; NCCN CNS Lymphoma Guidelines.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "류코보린(폴린산)은 이미 환원된 형태의 엽산으로, 디하이드로엽산환원효소(DHFR)의 작용 없이도 바로 활성 보조인자(테트라하이드로엽산)로 쓰일 수 있다. 따라서 메토트렉세이트가 DHFR을 계속 억제하는 상황에서도 정상 세포의 티미딜산·퓨린 합성에 필요한 1탄소 전달 반응을 우회적으로 복구시켜 준다 — 이는 효소 자리를 두고 경쟁하는 것이 아니라 대사 경로를 우회하는 '구제(rescue)' 기전이다."
   },
   {
    "k": "오답감별",
    "v": "A: 류코보린은 DHFR 자리에서 메토트렉세이트와 직접 경쟁해 효소를 되살리는 것이 아니라, DHFR을 거치지 않고 하류 대사산물을 바로 공급하는 우회 기전이다.\nC: 유기음이온수송체 억제는 신장 배설 관련 약물상호작용(예: NSAID·페니실린류) 기전이며, 류코보린 구제의 작용기전이 아니다.\nD: 소변 알칼리화는 메토트렉세이트 결정 형성을 막아 신독성을 예방하는 별도의 예방 전략(수액·중탄산나트륨)이며, 류코보린의 세포 내 구제 기전과는 무관하다.\nE: 류코보린은 간 사이토크롬 효소를 유도해 메토트렉세이트 대사를 가속시키지 않는다. 메토트렉세이트는 주로 신장으로 미변화 배설된다."
   },
   {
    "k": "임상핵심",
    "v": "고용량 MTX 독성 시 류코보린은 DHFR 억제를 '되돌리는' 것이 아니라 환원엽산을 직접 공급해 우회한다 — 예방(수액·소변알칼리화)과 구제(류코보린)는 서로 다른 전략임을 구분한다."
   },
   {
    "k": "출처",
    "v": "UpToDate — Pharmacology of high-dose methotrexate and leucovorin rescue; NCCN CNS Lymphoma Guidelines."
   }
  ],
 ...
 },
 {
  ...
  "type": "Postpartum Hemorrhage (Uterine Atony — Uterotonic Selection with Dual Contraindications)",
  "difficulty": 5,
  "created": "2026-07-28",
  "vignette": "A 28-year-old woman with chronic hypertension and asthma undergoes vaginal delivery of a 4.2-kg infant after a prolonged second stage. She now has heavy vaginal bleeding with a soft, boggy uterus palpable above the umbilicus. The placenta is intact and no lacerations are found on exam. Bleeding continues despite vigorous fundal massage and a first-line intravenous oxytocin infusion at the maximum recommended rate. Vital signs and laboratory studies are shown.",
  "question": "Which of the following is the most appropriate next step in management?",
  "options": [
   "Intramuscular carboprost tromethamine (15-methyl prostaglandin F2α)",
   "Intramuscular methylergonovine",
   "Sublingual or rectal misoprostol",
   "Repeating the intravenous oxytocin infusion at the same rate",
   "Uterine artery embolization as the immediate next step"
  ],
  "answer": 3,
  "explanationText": "- 정답근거: 옥시토신 최대용량에도 반응하지 않는 자궁이완증에는 2차 자궁수축제가 필요하다. 이 환자는 천식(카보프로스트 금기 — 기관지수축 위험)과 만성 고혈압(메틸에르고노빈 금기 — 중증 고혈압·뇌졸중 위험)을 동시에 가지고 있어 두 약제 모두 배제되고, 심혈관·호흡기 금기가 상대적으로 적은 미소프로스톨이 남는다.\n- 오답감별:\n  - A: 카보프로스트는 효과적인 2차 자궁수축제이지만 천식 환자에서는 기관지수축을 유발할 수 있어 금기다.\n  - B: 메틸에르고노빈은 강력한 자궁수축 효과가 있으나 고혈압·자간전증 환자에서는 혈압을 급격히 상승시켜 뇌졸중 위험을 높이므로 금기다.\n  - D: 이미 최대용량 옥시토신 주입에도 출혈이 지속되고 있으므로, 같은 용량을 반복하는 것은 추가 효과를 기대하기 어렵고 치료 지연만 초래한다.\n  - E: 자궁동맥색전술은 자궁수축제(2차 약물 포함)에 불응하는 지속 출혈에서 고려하는 다음 단계이며, 아직 2차 약물요법을 시도하지 않은 이 시점에 바로 시행하는 것은 순서를 건너뛰는 것이다.\n- 임상핵심: 옥시토신 불응성 자궁이완증에서 2차 자궁수축제는 효과보다 먼저 환자별 금기(천식→카보프로스트 금기, 고혈압→메틸에르고노빈 금기)를 배제해 선택해야 한다.\n- 출처: ACOG Practice Bulletin — Postpartum Hemorrhage; CMQCC OB Hemorrhage Toolkit.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "옥시토신 최대용량에도 반응하지 않는 자궁이완증에는 2차 자궁수축제가 필요하다. 이 환자는 천식(카보프로스트 금기 — 기관지수축 위험)과 만성 고혈압(메틸에르고노빈 금기 — 중증 고혈압·뇌졸중 위험)을 동시에 가지고 있어 두 약제 모두 배제되고, 심혈관·호흡기 금기가 상대적으로 적은 미소프로스톨이 남는다."
   },
   {
    "k": "오답감별",
    "v": "A: 카보프로스트는 효과적인 2차 자궁수축제이지만 천식 환자에서는 기관지수축을 유발할 수 있어 금기다.\nB: 메틸에르고노빈은 강력한 자궁수축 효과가 있으나 고혈압·자간전증 환자에서는 혈압을 급격히 상승시켜 뇌졸중 위험을 높이므로 금기다.\nD: 이미 최대용량 옥시토신 주입에도 출혈이 지속되고 있으므로, 같은 용량을 반복하는 것은 추가 효과를 기대하기 어렵고 치료 지연만 초래한다.\nE: 자궁동맥색전술은 자궁수축제(2차 약물 포함)에 불응하는 지속 출혈에서 고려하는 다음 단계이며, 아직 2차 약물요법을 시도하지 않은 이 시점에 바로 시행하는 것은 순서를 건너뛰는 것이다."
   },
   {
    "k": "임상핵심",
    "v": "옥시토신 불응성 자궁이완증에서 2차 자궁수축제는 효과보다 먼저 환자별 금기(천식→카보프로스트 금기, 고혈압→메틸에르고노빈 금기)를 배제해 선택해야 한다."
   },
   {
    "k": "출처",
    "v": "ACOG Practice Bulletin — Postpartum Hemorrhage; CMQCC OB Hemorrhage Toolkit."
   }
  ],
 ...
 },
 {
  ...
  "type": "Methotrexate Toxicity — Leucovorin (Folinic Acid) Rescue Mechanism",
  "difficulty": 4,
  "created": "2026-07-30",
  "vignette": "A 9-year-old girl with high-grade osteosarcoma is receiving high-dose methotrexate as part of chemotherapy. On day 3, she develops oral mucositis. Vital signs and laboratory studies are shown. She is started on IV hydration, urinary alkalinization, and leucovorin, dosed according to her serum methotrexate level.",
  "question": "Leucovorin reduces methotrexate-induced cytotoxicity by which of the following mechanisms?",
  "options": [
   "Bypassing dihydrofolate reductase blockade by supplying reduced folate for thymidylate and purine synthesis",
   "Competitively displacing methotrexate from renal tubular transporters to enhance urinary excretion",
   "Inhibiting hepatic cytochrome P450 metabolism of methotrexate to lower circulating active drug levels",
   "Chelating methotrexate in the plasma to form an inactive, renally excreted complex",
   "Directly inhibiting dihydrofolate reductase to prevent further methotrexate binding at the active site"
  ],
  "answer": 1,
  "explanationText": "- 정답근거: 메토트렉세이트는 DHFR을 억제해 테트라하이드로엽산(활성 환원엽산) 생성을 차단하고, 이로 인해 티미딜산·퓨린 합성이 멈춰 골수·점막처럼 빠르게 분열하는 세포가 손상된다(점막염·호중구감소로 확인됨). 류코보린은 이미 환원된 엽산 형태이므로 DHFR 단계 자체를 우회해 세포에 환원엽산을 직접 공급하고, 정상세포의 핵산 합성을 구제한다.\n- 오답감별:\n  - (B) 신세뇨관 수송체 경쟁적 치환: 류코보린의 구제 기전이 아니며, 배설 촉진은 수액·요알칼리화가 담당한다.\n  - (C) 간 CYP450 억제: 메토트렉세이트는 CYP450으로 주로 대사되지 않고 신장으로 배설되며, 류코보린은 대사효소에 작용하지 않는다.\n  - (D) 혈장 킬레이션: 류코보린은 메토트렉세이트를 직접 결합·불활성화하지 않는다(이 역할은 효소적으로 메토트렉세이트를 분해하는 글루카르피다제에 가깝다).\n  - (E) DHFR 직접 억제: 류코보린은 효소를 억제하는 것이 아니라 그 하류 산물(환원엽산)을 공급해 억제를 우회한다.\n- 임상핵심: 고용량 메토트렉세이트 = 수액+요알칼리화(결정 신병증 예방) + 류코보린 구제(DHFR 우회, 노모그램 기반 용량) — 신독성 동반 시 글루카르피다제 추가 고려.\n- 출처: Katzung's Basic & Clinical Pharmacology; NCCN High-Dose Methotrexate Guidelines.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "메토트렉세이트는 DHFR을 억제해 테트라하이드로엽산(활성 환원엽산) 생성을 차단하고, 이로 인해 티미딜산·퓨린 합성이 멈춰 골수·점막처럼 빠르게 분열하는 세포가 손상된다(점막염·호중구감소로 확인됨). 류코보린은 이미 환원된 엽산 형태이므로 DHFR 단계 자체를 우회해 세포에 환원엽산을 직접 공급하고, 정상세포의 핵산 합성을 구제한다."
   },
   {
    "k": "오답감별",
    "v": "(B) 신세뇨관 수송체 경쟁적 치환: 류코보린의 구제 기전이 아니며, 배설 촉진은 수액·요알칼리화가 담당한다.\n(C) 간 CYP450 억제: 메토트렉세이트는 CYP450으로 주로 대사되지 않고 신장으로 배설되며, 류코보린은 대사효소에 작용하지 않는다.\n(D) 혈장 킬레이션: 류코보린은 메토트렉세이트를 직접 결합·불활성화하지 않는다(이 역할은 효소적으로 메토트렉세이트를 분해하는 글루카르피다제에 가깝다).\n(E) DHFR 직접 억제: 류코보린은 효소를 억제하는 것이 아니라 그 하류 산물(환원엽산)을 공급해 억제를 우회한다."
   },
   {
    "k": "임상핵심",
    "v": "고용량 메토트렉세이트 = 수액+요알칼리화(결정 신병증 예방) + 류코보린 구제(DHFR 우회, 노모그램 기반 용량) — 신독성 동반 시 글루카르피다제 추가 고려."
   },
   {
    "k": "출처",
    "v": "Katzung's Basic & Clinical Pharmacology; NCCN High-Dose Methotrexate Guidelines."
   }
  ],
  "source": "USMLE-style / MedKOS (pharmacology · antimetabolite rescue)",
  "vitals": [
  ...
  "labs": [
   {
    "name": "혈청 메토트렉세이트 농도(24시간)",
    "value": "15 μmol/L",
    "ref": "< 1.0 (24hr nomogram)"
   },
   {
    "name": "혈청 크레아티닌",
    "value": "1.3 mg/dL",
 ...
 },
 {
  ...
  "type": "Status Epilepticus — Stepwise Pharmacologic Management",
  "difficulty": 5,
  "created": "2026-07-30",
  "vignette": "A 34-year-old man is brought to the emergency department after his girlfriend witnessed 8 minutes of continuous generalized tonic-clonic convulsions with no return to baseline between episodes. On arrival, convulsions are ongoing. IV access is obtained, and he receives 4 mg IV lorazepam, followed by a second 4-mg dose 5 minutes later. Convulsions continue. Vital signs and laboratory studies are shown.",
  "question": "Which of the following is the most appropriate next step in management?",
  "options": [
   "Administer a third dose of IV lorazepam",
   "Obtain an emergent MRI of the brain before further pharmacologic treatment",
   "Load with an intravenous second-line antiseizure agent such as fosphenytoin",
   "Administer intramuscular midazolam as an alternative benzodiazepine route",
   "Begin a continuous propofol infusion with endotracheal intubation"
  ],
  "answer": 3,
  "explanationText": "- 정답근거: 8분 이상 지속되는 경련과 벤조디아제핀 2회 투여에도 지속되는 경련은 확립된(established) 경련지속상태다. 표준 알고리즘상 벤조디아제핀 최대 용량 이후 다음 단계는 정맥용 2차 항경련제(포스페니토인·레베티라세탐·발프로산) 부하이며, 젖산 상승은 지속 근육활동에 의한 것으로 추가 검사보다 처치가 우선이다.\n- 오답감별:\n  - (A) 세 번째 로라제팜: 이미 벤조디아제핀 최대 권장 용량(2회)을 투여했으므로 추가 투여는 호흡억제 위험만 늘리고 다음 단계를 지연시킨다.\n  - (B) 응급 MRI 우선: 영상은 경련 조절 이후 원인 감별에 필요하지만, 지속되는 경련 자체를 먼저 약물로 조절하는 것이 우선이다.\n  - (D) 근주 미다졸람: 이미 정맥로가 확보되어 벤조디아제핀을 정맥으로 투여한 상태이므로 근주 경로로 바꿀 이유가 없고, 이는 벤조디아제핀 단계를 반복하는 것일 뿐이다.\n  - (E) 프로포폴 지속주입: 2차 항경련제에도 반응하지 않는 '초난치성' 단계에서 고려하는 처치로, 이 환자는 아직 2차 약물을 시도하지 않았다.\n- 임상핵심: 경련지속상태 = 벤조디아제핀 최대 2회 → (반응 없으면) 2차 정맥 항경련제 부하 → (그래도 반응 없으면) 마취용량 지속주입+삽관, 단계를 건너뛰지 않는다.\n- 출처: AES/Neurocritical Care Society Guideline; ESETT Trial (NEJM).",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "8분 이상 지속되는 경련과 벤조디아제핀 2회 투여에도 지속되는 경련은 확립된(established) 경련지속상태다. 표준 알고리즘상 벤조디아제핀 최대 용량 이후 다음 단계는 정맥용 2차 항경련제(포스페니토인·레베티라세탐·발프로산) 부하이며, 젖산 상승은 지속 근육활동에 의한 것으로 추가 검사보다 처치가 우선이다."
   },
   {
    "k": "오답감별",
    "v": "(A) 세 번째 로라제팜: 이미 벤조디아제핀 최대 권장 용량(2회)을 투여했으므로 추가 투여는 호흡억제 위험만 늘리고 다음 단계를 지연시킨다.\n(B) 응급 MRI 우선: 영상은 경련 조절 이후 원인 감별에 필요하지만, 지속되는 경련 자체를 먼저 약물로 조절하는 것이 우선이다.\n(D) 근주 미다졸람: 이미 정맥로가 확보되어 벤조디아제핀을 정맥으로 투여한 상태이므로 근주 경로로 바꿀 이유가 없고, 이는 벤조디아제핀 단계를 반복하는 것일 뿐이다.\n(E) 프로포폴 지속주입: 2차 항경련제에도 반응하지 않는 '초난치성' 단계에서 고려하는 처치로, 이 환자는 아직 2차 약물을 시도하지 않았다."
   },
   {
    "k": "임상핵심",
    "v": "경련지속상태 = 벤조디아제핀 최대 2회 → (반응 없으면) 2차 정맥 항경련제 부하 → (그래도 반응 없으면) 마취용량 지속주입+삽관, 단계를 건너뛰지 않는다."
   },
   {
    "k": "출처",
    "v": "AES/Neurocritical Care Society Guideline; ESETT Trial (NEJM)."
   }
  ],
 ...
 },
 {
  ...
  "type": "Alcohol Withdrawal Delirium (Delirium Tremens) — Symptom-Triggered Benzodiazepine Therapy",
  "difficulty": 3,
  "created": "2026-07-30",
  "vignette": "A 48-year-old man with a 20-year history of heavy daily alcohol use is hospitalized for pancreatitis. On hospital day 3, he becomes agitated and diaphoretic, with a coarse hand tremor, and reports seeing insects crawling on the walls. He is disoriented to place and time. Vital signs and laboratory studies are shown.",
  "question": "Which of the following is the most appropriate next step in management?",
  "options": [
   "Immediate physical restraints alone, pending psychiatric evaluation",
   "Scheduled fixed-dose haloperidol as monotherapy for agitation",
   "Symptom-triggered benzodiazepine dosing guided by a standardized withdrawal scale (e.g., CIWA-Ar)",
   "Initiation of disulfiram to reduce further alcohol-seeking behavior",
   "Naltrexone administration to blunt autonomic symptoms and craving"
  ],
  "answer": 3,
  "explanationText": "- 정답근거: 만성 과음 병력, 입원 3일째(금단 발생 시간대와 일치) 발생한 초조·진전·환시·지남력장애와 자율신경 항진 소견은 진전섬망(알코올금단섬망)에 합당하다. 표준 1차 처치는 CIWA-Ar 같은 표준화 척도로 증상 중증도를 반복 평가해 그에 맞춰 용량을 주는 벤조디아제핀 증상유도 투여이며, 경련·섬망 악화를 예방하고 과다·과소 투여를 모두 줄인다.\n- 오답감별:\n  - (A) 신체 억제만: 근본 원인(GABA 저활성·글루탐산 과활성)을 교정하지 못하고 초조·자율신경 불안정을 오히려 악화시킬 수 있으며 약물치료를 대체할 수 없다.\n  - (B) 할로페리돌 고정용량 단독: 항정신병약은 경련역치를 낮출 수 있어 금단 경련 예방 효과가 있는 벤조디아제핀을 대체할 수 없고, 보조요법으로만 고려한다.\n  - (D) 디설피람: 금단이 끝난 후 재발 방지를 위한 약물이며, 현재 급성 섬망 상태에서 시작하면 자율신경 불안정을 오히려 악화시킬 수 있다.\n  - (E) 날트렉손: 갈망 감소 목적의 유지치료 약물로 급성 금단섬망의 자율신경 폭풍이나 경련을 조절하지 못한다.\n- 임상핵심: 진전섬망 = CIWA-Ar 기반 증상유도 벤조디아제핀이 1차 처치이며, 저마그네슘혈증 등 동반 전해질 이상을 함께 교정한다.\n- 출처: ASAM Clinical Practice Guideline on Alcohol Withdrawal Management; Kaplan & Sadock's Synopsis of Psychiatry.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "만성 과음 병력, 입원 3일째(금단 발생 시간대와 일치) 발생한 초조·진전·환시·지남력장애와 자율신경 항진 소견은 진전섬망(알코올금단섬망)에 합당하다. 표준 1차 처치는 CIWA-Ar 같은 표준화 척도로 증상 중증도를 반복 평가해 그에 맞춰 용량을 주는 벤조디아제핀 증상유도 투여이며, 경련·섬망 악화를 예방하고 과다·과소 투여를 모두 줄인다."
   },
   {
    "k": "오답감별",
    "v": "(A) 신체 억제만: 근본 원인(GABA 저활성·글루탐산 과활성)을 교정하지 못하고 초조·자율신경 불안정을 오히려 악화시킬 수 있으며 약물치료를 대체할 수 없다.\n(B) 할로페리돌 고정용량 단독: 항정신병약은 경련역치를 낮출 수 있어 금단 경련 예방 효과가 있는 벤조디아제핀을 대체할 수 없고, 보조요법으로만 고려한다.\n(D) 디설피람: 금단이 끝난 후 재발 방지를 위한 약물이며, 현재 급성 섬망 상태에서 시작하면 자율신경 불안정을 오히려 악화시킬 수 있다.\n(E) 날트렉손: 갈망 감소 목적의 유지치료 약물로 급성 금단섬망의 자율신경 폭풍이나 경련을 조절하지 못한다."
   },
   {
    "k": "임상핵심",
    "v": "진전섬망 = CIWA-Ar 기반 증상유도 벤조디아제핀이 1차 처치이며, 저마그네슘혈증 등 동반 전해질 이상을 함께 교정한다."
   },
   {
    "k": "출처",
    "v": "ASAM Clinical Practice Guideline on Alcohol Withdrawal Management; Kaplan & Sadock's Synopsis of Psychiatry."
   }
  ],
  "source": "USMLE-style / MedKOS (psychiatry · substance withdrawal)",
  "vitals": [
 ...
 },
 {
  ...
  "type": "Chronic Granulomatous Disease (NADPH oxidase respiratory burst defect)",
  "difficulty": 4,
  "created": "2026-08-04",
  "vignette": "A 4-year-old boy has had recurrent skin abscesses caused by Staphylococcus aureus, suppurative lymphadenitis, and now presents with fever and a pulmonary infiltrate found on imaging to be caused by Aspergillus species. Vital signs and laboratory studies are shown; serum immunoglobulin levels and lymphocyte counts are normal. A dihydrorhodamine (DHR) flow cytometry assay shows markedly reduced oxidation compared with controls.",
  "question": "The enzyme defect underlying this patient's recurrent infections most directly impairs which of the following processes?",
  "options": [
   "Complement-mediated opsonization of encapsulated bacteria via the classical pathway",
   "CD40-CD40 ligand interaction required for immunoglobulin class switching",
   "MHC class II-mediated antigen presentation to CD4+ helper T cells",
   "Microtubule-dependent fusion of phagosomes with lysosomes",
   "NADPH oxidase-mediated generation of superoxide during the phagocyte respiratory burst"
  ],
  "answer": 5,
  "explanationText": "- 정답근거: 카탈라아제양성균(S. aureus, Aspergillus)에 의한 반복 감염, 정상 면역글로불린·림프구 수, DHR 산화 현저히 감소는 만성육아종병(CGD)의 전형적 소견이다. CGD는 식세포의 NADPH oxidase 복합체 결함으로 활성산소(superoxide) 생성이 안 되어 호흡폭발(respiratory burst)에 의한 산화적 살균이 실패하는 질환이다.\n- 오답감별:\n  - A: 보체매개 옵소닌화 결함은 반복 화농성 감염을 유발하지만 정상 면역글로불린·DHR 이상을 설명하지 못하며, 보체결핍은 대개 나이세리아균 반복감염과 연관된다.\n  - B: CD40-CD40L 상호작용 결함은 Hyper-IgM 증후군의 기전으로, IgM은 정상이나 IgG/IgA가 낮게 나오는 것이 특징이다 — 이 환자는 면역글로불린이 모두 정상이라 부합하지 않는다.\n  - C: MHC class II 발현 소실은 Bare lymphocyte syndrome의 기전으로 CD4+ T세포 발달 저하와 저감마글로불린혈증을 동반하는 경우가 많다 — DHR 이상과는 무관하다.\n  - D: 미세소관 의존 파고솜-리소좀 융합 결함은 Chediak-Higashi 증후군의 기전이며 거대세포질과립·부분백색증을 동반한다 — 이 환자 소견과 다르다.\n- 임상핵심: 카탈라아제양성균 반복감염 + 정상 면역글로불린/림프구 + DHR(또는 NBT) 검사 이상 → 만성육아종병(CGD)을 우선 의심한다. 확진은 DHR 유세포검사 또는 유전자검사로 한다.\n- 출처: Janeway's Immunobiology; UpToDate — Chronic Granulomatous Disease.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "카탈라아제양성균(S. aureus, Aspergillus)에 의한 반복 감염, 정상 면역글로불린·림프구 수, DHR 산화 현저히 감소는 만성육아종병(CGD)의 전형적 소견이다. CGD는 식세포의 NADPH oxidase 복합체 결함으로 활성산소(superoxide) 생성이 안 되어 호흡폭발(respiratory burst)에 의한 산화적 살균이 실패하는 질환이다."
   },
   {
    "k": "오답감별",
    "v": "A: 보체매개 옵소닌화 결함은 반복 화농성 감염을 유발하지만 정상 면역글로불린·DHR 이상을 설명하지 못하며, 보체결핍은 대개 나이세리아균 반복감염과 연관된다.\nB: CD40-CD40L 상호작용 결함은 Hyper-IgM 증후군의 기전으로, IgM은 정상이나 IgG/IgA가 낮게 나오는 것이 특징이다 — 이 환자는 면역글로불린이 모두 정상이라 부합하지 않는다.\nC: MHC class II 발현 소실은 Bare lymphocyte syndrome의 기전으로 CD4+ T세포 발달 저하와 저감마글로불린혈증을 동반하는 경우가 많다 — DHR 이상과는 무관하다.\nD: 미세소관 의존 파고솜-리소좀 융합 결함은 Chediak-Higashi 증후군의 기전이며 거대세포질과립·부분백색증을 동반한다 — 이 환자 소견과 다르다."
   },
   {
    "k": "임상핵심",
    "v": "카탈라아제양성균 반복감염 + 정상 면역글로불린/림프구 + DHR(또는 NBT) 검사 이상 → 만성육아종병(CGD)을 우선 의심한다. 확진은 DHR 유세포검사 또는 유전자검사로 한다."
   },
   {
    "k": "출처",
    "v": "Janeway's Immunobiology; UpToDate — Chronic Granulomatous Disease."
   }
  ],
 ...
 },
 {
  ...
  "difficulty": 4,
  "created": "2026-08-04",
  "vignette": "A 68-year-old man is brought to the emergency department 2 hours and 10 minutes after the witnessed sudden onset of right-sided weakness and difficulty speaking. He takes no anticoagulant or antiplatelet medication and has had no recent surgery or bleeding. Vital signs and initial studies are shown; noncontrast CT of the head shows no hemorrhage and no early ischemic changes involving more than one-third of the middle cerebral artery territory.",
  "question": "Which of the following is the most appropriate next step in management?",
  "options": [
   "Administer intravenous alteplase immediately without addressing the blood pressure",
   "Lower blood pressure with intravenous labetalol to below 185/110 mmHg, then administer intravenous alteplase",
   "Give aspirin 325 mg orally now and defer thrombolytic therapy",
   "Proceed directly to mechanical thrombectomy without administering thrombolytic therapy",
   "Obtain CT angiography before making any treatment decision, delaying thrombolysis"
  ],
  "answer": 2,
  "explanationText": "- 정답근거: 발병 2시간 10분으로 정맥내 알테플라제 적응 시간대 안에 있고, 출혈·최근수술·항응고제 복용 등 금기가 없으며 CT에서도 배제기준에 해당하지 않는다. 다만 혈압이 196/110mmHg로 185/110mmHg 기준을 초과하므로, 정맥내 강압제(라베탈롤 등)로 신속히 혈압을 낮춘 뒤 지체 없이 알테플라제를 투여하는 것이 다음 단계다.\n- 오답감별:\n  - A: 혈압이 185/110mmHg를 초과한 상태에서 강압 없이 알테플라제를 투여하면 뇌출혈 위험이 높아진다 — 혈압 확인·조정 없이 바로 투여하는 것은 안전기준을 건너뛰는 것이다.\n  - C: 아스피린은 급성기 알테플라제 투여 후 24시간 동안은 출혈 위험 때문에 병용하지 않으며, 혈전용해 적응증을 만족하는 환자에서 항혈소판제로 대체하는 것은 표준 치료가 아니다.\n  - D: 이 환자는 대혈관폐색 여부가 아직 확인되지 않았고 정맥내 알테플라제의 금기도 없다. 혈전제거술이 필요하더라도 알테플라제 투여를 생략하지 않고 함께(또는 먼저) 진행하는 것이 원칙이다.\n  - E: CT혈관조영술을 이유로 혈전용해를 미루는 것은 \"시간이 곧 뇌\"라는 원칙에 반한다. 이미 출혈 배제와 시간 기준이 확인되었으므로 추가 영상을 이유로 치료를 지연해서는 안 된다.\n- 임상핵심: 급성 허혈성 뇌졸중에서 혈압 ≥185/110mmHg는 알테플라제의 일시적 장벽일 뿐, 절대 금기가 아니다 — 신속히 낮추고 곧바로 투여한다(\"치료를 미루는 것\"이 아니라 \"치료를 위한 준비\"로 접근한다).\n- 출처: 2019 AHA/ASA Guideline for Early Management of Acute Ischemic Stroke; UpToDate — IV Thrombolytic Therapy.",
  "explanationItems": [
   {
    "k": "정답근거",
    "v": "발병 2시간 10분으로 정맥내 알테플라제 적응 시간대 안에 있고, 출혈·최근수술·항응고제 복용 등 금기가 없으며 CT에서도 배제기준에 해당하지 않는다. 다만 혈압이 196/110mmHg로 185/110mmHg 기준을 초과하므로, 정맥내 강압제(라베탈롤 등)로 신속히 혈압을 낮춘 뒤 지체 없이 알테플라제를 투여하는 것이 다음 단계다."
   },
   {
    "k": "오답감별",
    "v": "A: 혈압이 185/110mmHg를 초과한 상태에서 강압 없이 알테플라제를 투여하면 뇌출혈 위험이 높아진다 — 혈압 확인·조정 없이 바로 투여하는 것은 안전기준을 건너뛰는 것이다.\nC: 아스피린은 급성기 알테플라제 투여 후 24시간 동안은 출혈 위험 때문에 병용하지 않으며, 혈전용해 적응증을 만족하는 환자에서 항혈소판제로 대체하는 것은 표준 치료가 아니다.\nD: 이 환자는 대혈관폐색 여부가 아직 확인되지 않았고 정맥내 알테플라제의 금기도 없다. 혈전제거술이 필요하더라도 알테플라제 투여를 생략하지 않고 함께(또는 먼저) 진행하는 것이 원칙이다.\nE: CT혈관조영술을 이유로 혈전용해를 미루는 것은 \"시간이 곧 뇌\"라는 원칙에 반한다. 이미 출혈 배제와 시간 기준이 확인되었으므로 추가 영상을 이유로 치료를 지연해서는 안 된다."
   },
   {
    "k": "임상핵심",
    "v": "급성 허혈성 뇌졸중에서 혈압 ≥185/110mmHg는 알테플라제의 일시적 장벽일 뿐, 절대 금기가 아니다 — 신속히 낮추고 곧바로 투여한다(\"치료를 미루는 것\"이 아니라 \"치료를 위한 준비\"로 접근한다)."
   },
   {
    "k": "출처",
    "v": "2019 AHA/ASA Guideline for Early Management of Acute Ischemic Stroke; UpToDate — IV Thrombolytic Therapy."
   }
  ],
