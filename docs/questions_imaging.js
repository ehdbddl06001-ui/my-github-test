...
window.IMAGING_QUESTIONS = [
 {
  ...
  "explanationItems": [
   ...
   {
    "k": "오답 이유",
    "v": "(A) A sinusoidal pattern is a smooth, regular sine wave of 3–5 cycles/min lasting ≥20 minutes\n(C) A variable deceleration is abrupt but lasts from 15 seconds to less than 2 minutes; this one lasts about 2.3 minutes\n(D) A late deceleration is gradual, its nadir follows the contraction peak, and it recurs with contractions; here the fall begins before the contraction rises\n(E) An early deceleration is a shallow, gradual mirror image of the contraction with its nadir at the contraction peak"
   },
   {
    "k": "함정",
 ...
 },
 {
  ...
  "explanationItems": [
   ...
   {
    "k": "오답 이유",
    "v": "(A) AMH is a Sertoli-cell product that acts on Müllerian ducts\n(B) Prolactin is not the trophic hormone for testicular steroidogenesis\n(D) FSH acts on Sertoli cells inside the seminiferous tubules, which are negative here\n(E) Inhibin B is secreted by Sertoli cells and acts on the pituitary; it has no Leydig-cell target role"
   },
   {
    "k": "함정",
 ...
 },
 {
  ...
  "explanationItems": [
   ...
   {
    "k": "오답 이유",
    "v": "① 외부생식기 남성화는 테스토스테론이 5α-환원효소로 바뀐 DHT 의 작용\n② 경복부 하강은 주로 간질세포가 분비하는 INSL3 가 고환도대를 통해 매개한다\n③ hCG 는 태반 합체영양막이 분비하며 고환 세포가 촉진하지 않는다\n⑤ 볼프관 분화 유지는 간질(Leydig)세포의 테스토스테론 작용 — 간질세포는 여기서 음성이다"
   },
   {
    "k": "함정",
 ...
 },
 {
  ...
  "explanationItems": [
   ...
   {
    "k": "오답 이유",
    "v": "② 아데노신은 미주신경자극이 실패했을 때의 다음 단계다\n③ 동기화 율동전환은 저혈압·의식저하·흉통 같은 불안정 징후가 있을 때\n④ 아미오다론은 좁은 QRS 규칙적 빈맥의 1차 약이 아니다\n⑤ 디곡신은 효과 발현이 느려 급성 종료 목적에 쓰지 않는다"
   },
   {
    "k": "함정",
 ...
 },
 {
  ...
  "explanationItems": [
   ...
   {
    "k": "오답 이유",
    "v": "① SV1+RV5 ≈2.2 mV, RaVL ≈1.0 mV 로 전압 기준 미달이며, 설령 비대가 있어도 「제한 없음」은 QT 연장을 놓친 답이다\n② T파는 낮고 넓게 늘어져 있지 뾰족·좁은 텐트 모양이 아니다 — 고칼륨혈증 소견이 아니다\n④ 드로페리돌은 온단세트론보다 QT 연장 경고가 더 강한 약(블랙박스 경고) — QT 연장 환자에게 우선 쓰면 안 된다\n⑤ P파가 규칙적으로 QRS 앞에 일정한 간격으로 있어 방실해리가 없다 — 완전방실차단이 아니다"
   },
   {
    "k": "함정",
