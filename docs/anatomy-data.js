...
window.MEDKOS_ANATOMY = {
 ...
 "questions": [
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 얕은층)에서 번호핀 1~10가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 얕은근막 속의 짝 / 2. 종아리·발 안쪽 / 3. 종아리 뒤·발 가쪽 / 4. 등의 얕은층 / 5. 큰두렁정맥 / 6. 두렁신경 / 7. 작은두렁정맥 / 8. 장딴지신경 / 9. 뒤가지의 피부가지 / 10. 동반 피부정맥",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 등·볼기)에서 번호핀 1~15가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 큰궁둥구멍 / 2. 위구멍 / 3. 아래구멍 / 4. 어깨뼈 안쪽모서리 / 5. 위볼기동맥 / 6. 위볼기정맥 / 7. 위볼기신경 / 8. 아래볼기 A·V / 9. 아래볼기신경 / 10. 궁둥신경 / 11. 뒤넙다리피부신경 / 12. 속음부 A·V / 13. 음부신경 / 14. 등쪽어깨동맥 / 15. 등쪽어깨신경",
  ...
  },
  {
   ...
   "subregion": "s03-nerve",
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(궁둥신경에서 발까지)에서 번호핀 1~13가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 궁둥신경 / 2. 정강신경 / 3. 온종아리신경 / 4. 안쪽장딴지피부신경 / 5. 종아리 뒤칸 근육 전부 / 6. 발목굴 통과 / 7. 가쪽장딴지피부신경 / 8. 장딴지신경교통가지 / 9. 얕은종아리신경 / 10. 깊은종아리신경 / 11. 안쪽발바닥신경 / 12. 가쪽발바닥신경 / 13. 장딴지신경",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(빗장밑동맥과 오금동맥)에서 번호핀 1~22가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 빗장밑동맥 / 넙다리동맥 / 2. 빗장밑동맥 / 3. 겨드랑동맥 / 4. 오금동맥 / 5. 오금정맥 / 6. 척추동맥 / 7. 갑상목동맥 / 8. 등쪽어깨동맥 / 9. 어깨밑동맥 / 10. 뒤위팔휘돌이동맥 / 11. 무릎동맥 5가지 / 12. 앞정강동맥 / 13. 뒤정강동맥 / 14. 작은두렁정맥 합류 / 15. 앞·뒤정강정맥 / 16. 넙다리정맥 / 17. 어깨위동맥 / 18. 가로목동맥 / 19. 어깨휘돌이동맥 / 20. 가슴등동맥 / 21. 중간무릎동맥 / 22. 종아리동맥",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 귀밑샘·갈비사이)에서 번호핀 1~16가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 네 개의 통로 / 2. 귀밑샘 속 / 3. 갈비사이고랑 / 4. 세모가슴근고랑 / 5. 얼굴의 구멍 짝 / 6. ① 얼굴신경 VII / 7. ② 아래턱뒤정맥 / 8. ③ 바깥목동맥 / 9. ① 갈비사이정맥 / 10. ② 갈비사이동맥 / 11. ③ 갈비사이신경 / 12. 노쪽피부정맥 / 13. 어깨세모가지 / 14. 눈확위구멍 / 15. 눈확아래구멍 / 16. 턱끝구멍",
  ...
  },
  {
   ...
   "subregion": "s04-nerve",
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(얼굴의 두 신경 — VII과 V)에서 번호핀 1~20가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 얼굴에 오는 뇌신경 / 2. 얼굴신경 VII / 3. 삼차신경 V / 4. 뒤귓바퀴신경 / 5. 관자가지 / 6. 광대가지 / 7. 볼가지 / 8. 턱모서리가지 / 9. 목가지 / 10. 눈신경 V1 / 11. 위턱신경 V2 / 12. 아래턱신경 V3 / 13. 눈확위신경 / 14. 도르래위신경 / 15. 눈물·코섬모체신경 / 16. 눈확아래신경 / 17. 광대얼굴·광대관자가지 / 18. 귓바퀴관자신경 / 19. 턱끝신경 / 20. 씹기근육 운동가지",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(얼굴·가슴벽의 동맥과 정맥)에서 번호핀 1~29가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 얼굴·가슴벽의 혈관 / 2. 바깥목동맥 / 3. 얼굴의 정맥 / 4. 가슴벽의 혈관 / 5. 얼굴동맥 / 6. 얕은관자동맥 / 7. 위턱동맥 / 8. 얼굴정맥 / 9. 아래턱뒤정맥 / 10. 겨드랑동맥 / 11. 속가슴동맥 / 12. 가슴대동맥 / 13. 아래입술동맥 / 14. 위입술동맥 / 15. 가쪽코동맥 / 16. 눈구석동맥 / 17. 가로얼굴동맥 / 18. 이마가지 / 19. 마루가지 / 20. 중간뇌막동맥 / 21. 눈확아래동맥 / 22. 온얼굴정맥 / 23. 앞가지 / 24. 뒤가지 / 25. 가슴봉우리동맥 / 26. 가쪽가슴동맥 / 27. 앞갈비사이동맥 / 28. 근육가로막·위배벽동맥 / 29. 뒤갈비사이동맥",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 목·넙다리)에서 번호핀 1~16가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 두 개의 '집' / 2. 목혈관신경집 / 3. 넙다리혈관집 / 4. 모음근굴 / 5. 방패목뿔막 / 6. 온목동맥 / 7. 속목정맥 / 8. 미주신경 X / 9. 넙다리신경 / 10. 넙다리동맥 / 11. 넙다리정맥 / 12. 넙다리관 + 림프절 / 13. 넙다리동·정맥 / 14. 두렁신경 / 15. 위후두동맥 / 16. 위후두신경 속가지",
  ...
  },
  {
   ...
   "subregion": "s06-nerve",
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(목·다리 앞의 신경 계보)에서 번호핀 1~24가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 목·다리 앞의 신경 / 2. 목신경얼기 / 3. 얼굴신경 VII / 4. 허리신경얼기 / 5. 피부가지 4개 / 6. 목신경고리 / 7. 가로막신경 C3–5 / 8. 목가지 / 9. 넙다리신경 L2–L4 / 10. 폐쇄신경 L2–L4 / 11. 가쪽넙다리피부신경 L2–3 / 12. 작은뒤통수신경 / 13. 큰귓바퀴신경 / 14. 가로목신경 / 15. 빗장위신경 / 16. 목뿔아래근육 / 17. 앞피부가지 / 18. 넙다리네갈래근·넙다리빗근 / 19. 두렁신경 / 20. 앞가지 / 21. 뒤가지 / 22. 긴모음근·두덩정강근·짧은모음근 / 23. 앞피부가지 / 24. 바깥폐쇄근·큰모음근 모음부분",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(바깥목동맥과 넙다리동맥)에서 번호핀 1~31가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 온목동맥 / 넙다리동맥 / 2. 온목동맥 / 3. 넙다리동맥 / 4. 속목정맥 / 5. 바깥목정맥 / 6. 넙다리정맥 / 7. 속목동맥 / 8. 바깥목동맥 / 9. 깊은넙다리동맥 / 10. 모음근구멍 통과 / 11. 얼굴정맥·혀정맥·위갑상정맥 / 12. 빗장밑정맥과 합류 / 13. 빗장밑정맥 / 14. 큰두렁정맥 / 15. 깊은넙다리정맥 / 16. 앞가지 / 17. 뒤가지 / 18. 안쪽가지 / 19. 종말가지 / 20. 안쪽넙다리휘돌이동맥 / 21. 가쪽넙다리휘돌이동맥 / 22. 관통동맥 3–4개 / 23. 오금동맥 / 24. 위갑상동맥 / 25. 혀동맥 / 26. 얼굴동맥 / 27. 뒤통수동맥 / 28. 뒤귓바퀴동맥 / 29. 오름인두동맥 / 30. 위턱동맥 / 31. 얕은관자동맥",
  ...
  },
  {
   ...
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 위가슴문·발목)에서 번호핀 1~15가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 세 개의 통로 / 2. 목갈비근틈새 / 3. 발목굴(굽힘근지지띠 밑) / 4. 종아리근지지띠 밑 / 5. 빗장밑정맥 / 6. 빗장밑동맥 2부 / 7. 팔신경얼기 / 8. ① 뒤정강근 힘줄 / 9. ② 긴발가락굽힘근 힘줄 / 10. ③ 뒤정강동맥 / 11. ④ 정강신경 / 12. ⑤ 긴엄지굽힘근 힘줄 / 13. 긴종아리근 힘줄 / 14. 짧은종아리근 힘줄 / 15. 얕은종아리신경",
  ...
  },
  {
   ...
   "subregion": "s07-nerve",
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(목뿌리·발목의 신경)에서 번호핀 1~16가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 7회차의 신경 / 2. 미주신경 X / 3. 가로막신경 / 4. 팔신경얼기 / 5. 온종아리신경 / 6. 정강신경 / 7. 되돌이후두신경(오른) / 8. 되돌이후두신경(왼) / 9. 위후두신경 / 10. 가로막 / 11. 위가슴문 통과 / 12. 얕은종아리신경 / 13. 깊은종아리신경 / 14. 안쪽발바닥신경 / 15. 가쪽발바닥신경 / 16. 안쪽발꿈치가지",
   ...
   "refs": [
    {
     "file": "임상해부학술기 3Q 2026 실습시간표 확정본",
     "page": null,
     "section": "5회차(2026-08-31) 실습주제 — 가슴벽·가슴안·가슴막·위세로칸·심장막·심장 / 관자부위·관자아래부위"
    },
    {
     "file": "pipelines/branch_specs.py s05-nerve",
     "page": null,
     "section": "5회차 계보 트리 — 가로막신경 / 미주신경"
    }
   ]
  },
  {
   ...
   "refs": [
    ...
    },
    {
     "file": "5회차 서브노트 카드",
     "page": null,
     "section": "§2-1. 복장뼈각 — 이 한 선에 걸리는 것들"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "refs": [
    ...
    },
    {
     "file": "pipelines/branch_specs.py s05-nerve",
     "page": null,
     "section": "5회차 계보 트리 — 얹혀 가는 섬유 — 고실끈신경"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "subregion": "s05-nerve",
   "examPhase": "tagging-1",
   "stem": "계보 구조도 퀴즈판(가슴안과 관자아래우묵의 신경)에서 번호핀 1~27가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 5회차의 신경 / 2. 가로막신경 / 3. 미주신경 X / 4. 갈비사이신경 / 5. 아래턱신경 V3 / 6. 얹혀 가는 섬유 / 7. 허파뿌리 앞으로 / 8. 왼되돌이후두신경 / 9. 허파가지·식도얼기 / 10. 심장가지 / 11. 벽쪽가슴막 감각 / 12. 가쪽·앞피부가지 / 13. 앞줄기 / 14. 뒤줄기 / 15. 고실끈신경 / 16. 귀신경절 / 17. 심장막가지 / 18. 가로막 운동 / 19. 가로막가슴막·배막 감각 / 20. 깊은관자신경 / 21. 깨물근신경 / 22. 가쪽날개근신경 / 23. 볼신경 / 24. 귓바퀴관자신경 / 25. 혀신경 / 26. 아래이틀신경 / 27. 턱목뿔근신경",
   ...
   "refs": [
    {
     "file": "2026 2회차 강의 스캔 97쪽",
     "page": null,
     "section": "넓은등근 이는곳·닿는곳·신경"
    },
    {
     "file": "임상해부학술기 3Q 2026 실습시간표 확정본",
     "page": null,
     "section": "2회차(2026-08-20) — 등 얕은층·중간층·깊은층 근육 / 볼기부위·넓적다리 뒤부분"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "2026 2회차 강의 스캔 97쪽",
     "page": null,
     "section": "중간볼기근·작은볼기근과 Trendelenburg"
    },
    {
     "file": "임상해부학술기 3Q 2026 실습시간표 확정본",
     "page": null,
  ...
  },
  {
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/diag-intercostal-layers-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "과거 학기 큰가슴근부위·가슴벽 영상 스캔 23장",
     "page": null,
     "section": "Thorax — Thoracic wall / intercostal space"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 큰가슴근부위·가슴벽 영상 스캔 23장",
     "page": null,
     "section": "Thorax — Thoracic wall / intercostal neurovascular bundle"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 큰가슴근부위·가슴벽 영상 스캔 23장",
     "page": null,
     "section": "Thorax — Thoracic wall / three layers of intercostal muscles"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 큰가슴근부위·가슴벽 영상 스캔 23장",
     "page": null,
     "section": "Thorax — Thoracic wall / arterial supply & anastomosis"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 얼굴·귀밑샘·씹기근육 영상 스캔 50장",
     "page": null,
     "section": "Head — Parotid region / structures within the parotid gland"
    },
    {
     "file": "과거 학기 큰가슴근부위·가슴벽 영상 스캔 23장",
     "page": null,
     "section": "Thorax — Thoracic wall / costal groove"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 얼굴·귀밑샘·씹기근육 영상 스캔 50장",
     "page": null,
     "section": "Head — Superficial layer of face / Trigeminal n. cutaneous branches"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 얼굴·귀밑샘·씹기근육 영상 스캔 50장",
     "page": null,
     "section": "Head — Muscles of mastication / masseter and temporalis"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 얼굴·귀밑샘·씹기근육 영상 스캔 50장",
     "page": null,
     "section": "Head — Parotid region / Facial n. branches"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 얼굴·귀밑샘·씹기근육 영상 스캔 50장",
     "page": null,
     "section": "Head — Facial artery and vein / transverse facial a."
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 큰가슴근부위·가슴벽 영상 스캔 23장",
     "page": null,
     "section": "Upper limb — Pectoral region / pectoral nerves and breast"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "과거 학기 얼굴·귀밑샘·씹기근육 영상 스캔 50장",
     "page": null,
     "section": "Head — Superficial layer of face / lips, external nose, external ear"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "2026학년도 2학기 수업계획서(실습계획표) — 7회차",
     "page": null,
     "section": "종아리 가쪽칸·발바닥 (e-Anatomy Lower limb — Leg 21:28–29:38 · Foot 05:43–17:17)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "2026학년도 2학기 수업계획서(실습계획표) — 7회차",
     "page": null,
     "section": "발바닥 신경 (e-Anatomy Lower limb — Foot 05:43–17:17)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "2026학년도 2학기 수업계획서(실습계획표) — 7회차",
     "page": null,
     "section": "발바닥 층 구성 (e-Anatomy Lower limb — Foot 05:43–17:17)"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-bundle-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "pipelines/branch_specs.py — s09-bundle",
     "page": null,
     "section": "함께 지나는 것 — 겨드랑·허파뿌리·뒤세로칸"
    }
   ]
  },
  {
   ...
   "subregion": "s09-bundle",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 겨드랑·허파뿌리·뒤세로칸)에서 **겨드랑** 계통에 해당하는 번호핀 2, 5, 6, 7, 8, 16, 17, 18, 19, 20, 21, 22, 23 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "2. 겨드랑 / 5. 네 벽 / 6. 꼭대기 = 목겨드랑관 / 7. 내용물 안쪽→가쪽 / 8. 겨드랑집 / 16. 앞벽 / 17. 뒤벽 / 18. 안쪽벽 / 19. 가쪽벽 / 20. ① 겨드랑정맥 / 21. ② 겨드랑동맥 / 22. ③ 팔신경얼기 다발 / 23. ④ 겨드랑림프절 5군",
   "explanation": "9회차 · 배열 순서가 그대로 태깅 문제가 되는 세 자리 겨드랑에서 **정맥이 가장 안쪽·앞**이다 — 중심정맥길이 여기로 난다. 허파뿌리 앞→뒤는 좌우 공통 **정–동–기**, 위→아래만 좌우가 다르다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-bundle-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s09-bundle",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 겨드랑·허파뿌리·뒤세로칸)에서 **허파뿌리** 계통에 해당하는 번호핀 3, 9, 10, 11, 12, 13, 24, 25, 26 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "3. 허파뿌리 / 9. 앞→뒤 (좌우 공통) / 10. 위→아래 오른쪽 / 11. 위→아래 왼쪽 / 12. 가로막신경 / 13. 미주신경 / 24. ① 허파정맥 / 25. ② 허파동맥 / 26. ③ 기관지",
   "explanation": "9회차 · 배열 순서가 그대로 태깅 문제가 되는 세 자리 겨드랑에서 **정맥이 가장 안쪽·앞**이다 — 중심정맥길이 여기로 난다. 허파뿌리 앞→뒤는 좌우 공통 **정–동–기**, 위→아래만 좌우가 다르다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-bundle-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s09-bundle",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 겨드랑·허파뿌리·뒤세로칸)에서 **뒤세로칸** 계통에 해당하는 번호핀 4, 14, 15, 27, 28, 29, 30, 31, 32, 33, 34 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "4. 뒤세로칸 / 14. 앞→뒤 층 순서 / 15. 가로막 구멍 3개 / 27. ① 식도 + 식도신경얼기 / 28. ② 가슴대동맥 / 29. ③ 가슴림프관 / 30. ④ 홀정맥 / 31. ⑤ 교감신경줄기 / 32. 대정맥구멍 T8 / 33. 식도구멍 T10 / 34. 대동맥구멍 T12",
   "explanation": "9회차 · 배열 순서가 그대로 태깅 문제가 되는 세 자리 겨드랑에서 **정맥이 가장 안쪽·앞**이다 — 중심정맥길이 여기로 난다. 허파뿌리 앞→뒤는 좌우 공통 **정–동–기**, 위→아래만 좌우가 다르다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-bundle-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s09-nerve",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(팔신경얼기와 가슴의 신경)에서 번호핀 1~36가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 9회차의 신경 / 2. 팔신경얼기 / 3. 뒤세로칸의 신경 / 4. 뿌리 / 5. 줄기 / 6. 갈래 / 7. 가쪽다발 / 8. 안쪽다발 / 9. 뒤다발 / 10. 미주신경 / 11. 교감신경줄기 / 12. 등쪽어깨신경 / 13. 긴가슴신경 / 14. 빗장밑근신경 / 15. 어깨위신경 / 16. 가쪽가슴근신경 / 17. 근육피부신경 / 18. 정중신경 가쪽뿌리 / 19. 안쪽가슴근신경 / 20. 안쪽위팔피부신경 / 21. 안쪽아래팔피부신경 / 22. 자신경 / 23. 정중신경 안쪽뿌리 / 24. 위·아래 어깨밑신경 / 25. 가슴등신경 / 26. 겨드랑신경 / 27. 노신경 / 28. 식도신경얼기 / 29. 왼되돌이후두신경 / 30. 오른되돌이후두신경 / 31. 백색교통가지 / 32. 회색교통가지 / 33. 큰내장신경 / 34. 작은내장신경 / 35. 가장작은내장신경 / 36. 별신경절",
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-nerve-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "pipelines/branch_specs.py — s09-nerve",
     "page": null,
     "section": "팔신경얼기와 가슴의 신경"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-vessel-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "pipelines/branch_specs.py — s09-vessel",
     "page": null,
     "section": "겨드랑동맥과 홀정맥계통"
    }
   ]
  },
  {
   ...
   "subregion": "s09-vessel",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(겨드랑동맥과 홀정맥계통)에서 **겨드랑동맥** 계통에 해당하는 번호핀 2, 6, 7, 8, 9, 20, 21, 22, 23, 24, 25, 26, 27 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "2. 겨드랑동맥 / 6. 1부 (가지 1) / 7. 2부 (가지 2) / 8. 3부 (가지 3) / 9. → 위팔동맥 / 20. 위가슴동맥 / 21. 가슴봉우리동맥 / 22. 가쪽가슴동맥 / 23. 어깨밑동맥 / 24. 뒤위팔휘돌이동맥 / 25. 앞위팔휘돌이동맥 / 26. 가슴등동맥 / 27. 어깨휘돌이동맥",
   "explanation": "9회차 · 근육이 동맥을 셋으로 나누고, 홀정맥이 가슴의 피를 되받는다 겨드랑동맥의 부(part) 번호 = 작은가슴근 기준 **안쪽 1 · 뒤 2 · 가쪽 3** 이고 가지 수도 1–2–3개다. 홀정맥은 위대정맥으로, 가슴림프관은 **왼정맥각**으로 — 액체 둘의 종착이 다르다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-vessel-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s09-vessel",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(겨드랑동맥과 홀정맥계통)에서 **허파순환·기관지동맥** 계통에 해당하는 번호핀 3, 10, 11, 12, 13 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "3. 허파순환·기관지동맥 / 10. 허파동맥줄기 / 11. 허파정맥 4개 / 12. 기관지동맥 / 13. 기관지정맥",
   "explanation": "9회차 · 근육이 동맥을 셋으로 나누고, 홀정맥이 가슴의 피를 되받는다 겨드랑동맥의 부(part) 번호 = 작은가슴근 기준 **안쪽 1 · 뒤 2 · 가쪽 3** 이고 가지 수도 1–2–3개다. 홀정맥은 위대정맥으로, 가슴림프관은 **왼정맥각**으로 — 액체 둘의 종착이 다르다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-vessel-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s09-vessel",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(겨드랑동맥과 홀정맥계통)에서 **가슴림프관** 계통에 해당하는 번호핀 5, 18, 19 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "5. 가슴림프관 / 18. 왼정맥각 / 19. 오른림프관",
   "explanation": "9회차 · 근육이 동맥을 셋으로 나누고, 홀정맥이 가슴의 피를 되받는다 겨드랑동맥의 부(part) 번호 = 작은가슴근 기준 **안쪽 1 · 뒤 2 · 가쪽 3** 이고 가지 수도 1–2–3개다. 홀정맥은 위대정맥으로, 가슴림프관은 **왼정맥각**으로 — 액체 둘의 종착이 다르다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s09-vessel-quiz.svg",
  ...
  },
  {
   ...
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(함께 지나는 것 — 팔오금 · 손목굴 · 고샅관)에서 번호핀 1~49가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 세 개의 자리 / 2. 팔오금 / 3. 손목굴 / 4. 고샅관 / 5. 경계 / 6. 내용물 가쪽→안쪽 (TAN) / 7. 얕은층 / 8. 네 기둥 / 9. 지나는 것 = 10개 / 10. 지나지 않는 것 / 11. 네 벽 / 12. 두 구멍 / 13. 탈장 감별 / 14. 정삭 — 세 막 세 근육 / 15. 정삭 내용물 / 16. 여성 / 17. 위변 / 18. 가쪽변 / 19. 안쪽변 / 20. 바닥 / 21. 지붕 / 22. ① 위팔두갈래근 힘줄 / 23. ② 위팔동맥 / 24. ③ 정중신경 / 25. 팔오금중간정맥 / 26. 가쪽아래팔피부신경 / 27. 몸쪽 가쪽 — 손배뼈결절 / 28. 몸쪽 안쪽 — 콩알뼈 / 29. 먼쪽 가쪽 — 큰마름뼈결절 / 30. 먼쪽 안쪽 — 갈고리뼈갈고리 / 31. 얕은손가락굽힘근 힘줄 4 / 32. 깊은손가락굽힘근 힘줄 4 / 33. 긴엄지굽힘근 힘줄 1 / 34. 정중신경 / 35. 앞벽 / 36. 뒤벽 / 37. 지붕 / 38. 바닥 / 39. 깊은고샅구멍 / 40. 얕은고샅구멍 / 41. 속고샅탈장 / 42. 직접고샅탈장 / 43. 바깥정삭근막 / 44. 고환올림근·근막 / 45. 속정삭근막 / 46. 정관 / 47. 고환동맥 / 48. 덩굴정맥얼기 / 49. 음부넙다리신경 생식가지",
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-bundle-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "pipelines/branch_specs.py — s10-bundle",
     "page": null,
     "section": "함께 지나는 것 — 팔오금 · 손목굴 · 고샅관"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "subregion": "s10-nerve",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 신경과 배벽의 신경)에서 번호핀 1~31가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 10회차의 신경 / 2. 정중신경 / 3. 자신경 / 4. 노신경 / 5. 근육피부신경 / 6. 배벽의 신경 — 갈비사이신경의 연속 / 7. 위팔 구간 / 8. 팔오금 통과 / 9. 아래팔 앞칸 얕은층 / 10. 앞뼈사이신경 / 11. 손바닥피부가지 / 12. 손목굴 통과 / 13. 안쪽위관절융기 뒤 / 14. 아래팔 앞칸 / 15. 손등가지 / 16. 자신경굴(Guyon) / 17. 깊은가지 → 뒤뼈사이신경 / 18. 얕은가지 / 19. 위팔노근·긴/짧은노쪽손목폄근 / 20. 가쪽아래팔피부신경 / 21. 가슴배신경 / 22. 갈비밑신경 / 23. 엉덩아랫배신경 / 24. 엉덩고샅신경 / 25. 음부넙다리신경 생식가지 / 26. 되돌이가지 / 27. 온바닥쪽손가락신경 / 28. 얕은가지 / 29. 깊은가지 / 30. 가쪽배피부가지 / 31. 앞배피부가지",
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-nerve-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "pipelines/branch_specs.py — s10-nerve",
     "page": null,
     "section": "위팔에서 손까지의 신경과 배벽의 신경"
    }
   ]
  },
  {
   ...
   "subregion": "s10-nerve",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 신경과 배벽의 신경)에서 **정중신경** 계통에 해당하는 번호핀 2, 7, 8, 9, 10, 11, 12, 26, 27 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "2. 정중신경 / 7. 위팔 구간 / 8. 팔오금 통과 / 9. 아래팔 앞칸 얕은층 / 10. 앞뼈사이신경 / 11. 손바닥피부가지 / 12. 손목굴 통과 / 26. 되돌이가지 / 27. 온바닥쪽손가락신경",
   "explanation": "10회차 · 세 신경이 칸을 나눠 갖고, 배벽은 갈비사이신경이 이어진다 칸이 신경을 정한다 — 앞칸은 **정중·자**, 뒤칸은 **노**(뒤뼈사이)가 맡는다. 손의 근육은 **자신경 깊은가지**가 거의 다 맡고, 정중신경은 엄지두덩 3근 + 벌레근 1·2뿐이다. 배벽 신경은 새로 생기지 않는다 — 갈비사이신경(T7–T11)이 그대로 내려와 이름만 바뀐다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-nerve-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s10-nerve",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 신경과 배벽의 신경)에서 **자신경** 계통에 해당하는 번호핀 3, 13, 14, 15, 16, 28, 29 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "3. 자신경 / 13. 안쪽위관절융기 뒤 / 14. 아래팔 앞칸 / 15. 손등가지 / 16. 자신경굴(Guyon) / 28. 얕은가지 / 29. 깊은가지",
   "explanation": "10회차 · 세 신경이 칸을 나눠 갖고, 배벽은 갈비사이신경이 이어진다 칸이 신경을 정한다 — 앞칸은 **정중·자**, 뒤칸은 **노**(뒤뼈사이)가 맡는다. 손의 근육은 **자신경 깊은가지**가 거의 다 맡고, 정중신경은 엄지두덩 3근 + 벌레근 1·2뿐이다. 배벽 신경은 새로 생기지 않는다 — 갈비사이신경(T7–T11)이 그대로 내려와 이름만 바뀐다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-nerve-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s10-nerve",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 신경과 배벽의 신경)에서 **노신경** 계통에 해당하는 번호핀 4, 17, 18, 19 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "4. 노신경 / 17. 깊은가지 → 뒤뼈사이신경 / 18. 얕은가지 / 19. 위팔노근·긴/짧은노쪽손목폄근",
   "explanation": "10회차 · 세 신경이 칸을 나눠 갖고, 배벽은 갈비사이신경이 이어진다 칸이 신경을 정한다 — 앞칸은 **정중·자**, 뒤칸은 **노**(뒤뼈사이)가 맡는다. 손의 근육은 **자신경 깊은가지**가 거의 다 맡고, 정중신경은 엄지두덩 3근 + 벌레근 1·2뿐이다. 배벽 신경은 새로 생기지 않는다 — 갈비사이신경(T7–T11)이 그대로 내려와 이름만 바뀐다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-nerve-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s10-nerve",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 신경과 배벽의 신경)에서 **근육피부신경** 계통에 해당하는 번호핀 5, 20 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "5. 근육피부신경 / 20. 가쪽아래팔피부신경",
   "explanation": "10회차 · 세 신경이 칸을 나눠 갖고, 배벽은 갈비사이신경이 이어진다 칸이 신경을 정한다 — 앞칸은 **정중·자**, 뒤칸은 **노**(뒤뼈사이)가 맡는다. 손의 근육은 **자신경 깊은가지**가 거의 다 맡고, 정중신경은 엄지두덩 3근 + 벌레근 1·2뿐이다. 배벽 신경은 새로 생기지 않는다 — 갈비사이신경(T7–T11)이 그대로 내려와 이름만 바뀐다. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-nerve-quiz.svg",
  ...
  },
  {
   ...
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 혈관과 배벽의 혈관)에서 번호핀 1~26가 가리키는 구조의 이름을 번호 순서대로 답하시오. 위에서 아래로, 왼쪽에서 오른쪽 순으로 매겨져 있다.",
   "choices": null,
   "answer": "1. 10회차의 혈관 / 2. 위팔동맥 / 3. 배벽의 동맥 / 4. 배벽의 얕은정맥 / 5. 덩굴정맥얼기 / 6. 깊은위팔동맥 / 7. 자쪽곁동맥(위·아래) / 8. 동반정맥 / 9. 노동맥 / 10. 자동맥 / 11. 위배벽동맥 / 12. 아래배벽동맥 / 13. 깊은엉덩휘돌이동맥 / 14. 배꼽 문합 / 15. 얕은배벽정맥 / 16. 얕은엉덩휘돌이정맥 / 17. 가슴배벽정맥 / 18. 배꼽옆정맥 / 19. 노쪽되돌이동맥 / 20. 해부코담배갑 통과 / 21. 깊은손바닥동맥활 / 22. 자쪽되돌이동맥 / 23. 온뼈사이동맥 / 24. 얕은손바닥동맥활 / 25. 온바닥쪽손가락동맥 / 26. 고유바닥쪽손가락동맥",
   ...
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-vessel-quiz.svg",
   "imageOrigin": "claude-drawn-svg",
   "refs": [
    {
     "file": "pipelines/branch_specs.py — s10-vessel",
     "page": null,
     "section": "위팔에서 손까지의 혈관과 배벽의 혈관"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "subregion": "s10-vessel",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 혈관과 배벽의 혈관)에서 **배벽의 동맥** 계통에 해당하는 번호핀 3, 11, 12, 13, 14 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "3. 배벽의 동맥 / 11. 위배벽동맥 / 12. 아래배벽동맥 / 13. 깊은엉덩휘돌이동맥 / 14. 배꼽 문합",
   "explanation": "10회차 · 위팔동맥이 팔오금에서 둘로 갈리고, 손에서 두 개의 활로 다시 만난다 팔의 동맥은 **갈라졌다가 다시 만난다** — 얕은/깊은 손바닥동맥활이 닫힌 고리다. 얕은활은 **자동맥**이, 깊은활은 **노동맥**이 주인이다(Allen 검사의 근거). 배벽은 **위·아래배벽동맥이 배꼽에서 문합**한다 — 대동맥과 엉덩동맥을 잇는 샛길. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
   "answerOnlyBacked": false,
   "image": "assets/anatomy/tree-s10-vessel-quiz.svg",
  ...
  },
  {
   ...
   "subregion": "s10-vessel",
   "examPhase": "tagging-2",
   "stem": "계보 구조도 퀴즈판(위팔에서 손까지의 혈관과 배벽의 혈관)에서 **덩굴정맥얼기** 계통에 해당하는 번호핀 5 번이 가리키는 구조의 이름을 번호 순서대로 답하시오.",
   "choices": null,
   "answer": "5. 덩굴정맥얼기",
   "explanation": "10회차 · 위팔동맥이 팔오금에서 둘로 갈리고, 손에서 두 개의 활로 다시 만난다 팔의 동맥은 **갈라졌다가 다시 만난다** — 얕은/깊은 손바닥동맥활이 닫힌 고리다. 얕은활은 **자동맥**이, 깊은활은 **노동맥**이 주인이다(Allen 검사의 근거). 배벽은 **위·아래배벽동맥이 배꼽에서 문합**한다 — 대동맥과 엉덩동맥을 잇는 샛길. 라벨판(tree-…-labeled.svg)과 짝이므로 퀴즈판을 먼저 풀고 라벨판으로 채점한다. 이 도해는 직접 그린 것이라 웹에 공개된다 — 실사 태깅 문항과 달리 화면에서 바로 풀 수 있다.",
   "confidence": "high",
  ...
  },
  {
   ...
   "refs": [
    {
     "file": "2026학년도 2학기 수업계획서(실습계획표) — 9회차",
     "page": null,
     "section": "응용과제 '팔신경얼기 부위별 손상' (SESSION_DETAILS[9].tasks)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "9차시(0911) 김홍태pf.pdf",
     "page": null,
     "section": "홀정맥계통 · 식도 · 내림대동맥 (descending aorta) · 가슴림프관"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "9차시(0911) 김홍태pf.pdf",
     "page": null,
     "section": "교감신경줄기 (sympathetic trunk) · 갈비사이신경"
    }
   ]
  },
  {
  ...
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "팔오금 구조물"
    }
   ]
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "엄지두덩근육 · 새끼두덩근육 · 손가락굽힘근힘줄과 벌레근 · 손바닥깊은곳"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위팔동맥, 노동맥 · 자동맥 (ulnar artery) · 손바닥 얕은곳의 혈관과 신경 · 손바닥깊은곳"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "아래팔 앞칸의 얕은층 근육 · 아래팔앞칸의 깊은층 근육 · 정중신경 · 자신경"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위팔동맥 · 위팔동맥, 노동맥 · 자동맥 (ulnar artery)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "배곧은근, 배곧은집 · 배바깥빗근, 고샅구멍 · 배속빗근 · 배가로근"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "고샅관 (inguinal canal) · 배바깥빗근, 고샅구멍 · 앞배벽속면 구조물 · 배가로근"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "정삭 (spermatic cord) · 배속빗근 · 고샅관 (inguinal canal)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위팔앞칸의 신경 · 정중신경 (median nerve) · 아래팔 앞칸의 얕은층 근육 · 아래팔앞칸의 깊은층 근육 · 손목굴 (carpal tunnel) · 엄지두덩근육"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "자신경 (ulnar nerve) · 아래팔앞칸의 깊은층 근육 · 손목굴 (carpal tunnel) · 새끼두덩근육, 자신경의 깊은가지 분포 · 손바닥깊은곳"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "피부벗기기 · 손바닥널힘줄 (palmar aponeurosis) · 손바닥 얕은곳의 혈관과 신경 · 손가락굽힘근힘줄과 벌레근 · 손바닥깊은곳"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위팔동맥, 노동맥 · 자동맥 (ulnar artery) · 아래팔 앞칸의 얕은층 근육 · 폄근지지띠, 섬유칸 · 손바닥 얕은곳의 혈관과 신경 · 손바닥깊은곳"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "얕은근막 · 배곧은근, 배곧은집 · 배속빗근 · 배가로근 · 앞배벽속면 구조물 · 고샅관 (inguinal canal)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "10차시(0918) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "고환 (testis) · 정삭 (spermatic cord) · 고샅관 (inguinal canal)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "노신경 · 위팔세갈래근 (triceps brachii m.) · 손뒤침근 (supinator muscle) · 아래팔뒤칸의 깊은층 노출 · 손등표면"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위팔세갈래근 (triceps brachii m.) · 노신경"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "아래팔뒤칸의 얕은층 근육 · 손뒤침근 (supinator muscle) · 노신경"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "폄근지지띠 섬유칸 · 아래팔뒤칸의 깊은층 근육 · 손가락폄근의 힘줄"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "손등표면 · 폄근지지띠 섬유칸 · 아래팔뒤칸의 깊은층 근육"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "복막구조물 · 큰창자 · 샘창자 (duodenum) · 이자 (길이가 긴 샘조직)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "그물막주머니 (omental bursa) · 복막구조물 · 간의 겉모습 · 주변혈관관찰"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "간의 겉모습 · 간의 속구조 · 간의 적출 · 그물막주머니 (omental bursa) · 이자관"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위의 혈관분포 · 위의 겉모습 · 주변혈관관찰 · 지라 · 샘창자 (duodenum)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위창자간막동맥 (superior mesenteric artery) · 아래창자간막동맥 (inferior mesenteric artery) · 큰창자 · 주변혈관관찰"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "큰창자 · 위창자간막동맥 (superior mesenteric artery) · 복막구조물"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "이자 (길이가 긴 샘조직) · 이자관 · 샘창자 (duodenum) · 간의 속구조 · 주변혈관관찰"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "아래팔뒤칸의 깊은층 노출 · 아래팔뒤칸의 깊은층 근육 · 손뒤침근 (supinator muscle)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "지라 · 주변혈관관찰 · 그물막주머니 (omental bursa)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "11차시(0922) 허미선pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "위의 겉모습 · 위의 혈관분포 · 샘창자 (duodenum) · 이자관 · 복막구조물"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "척주관열기 · 척수막"
    },
    {
     "file": "2026학년도 2학기 수업계획서(실습계획표) — 12회차",
     "page": null,
     "section": "응용과제 — 척주관·척수 길이차와 허리천자"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "궁둥항문오목 (ischioanal fossa) · 궁둥항문오목의 혈관과 신경"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "궁둥항문오목의 혈관과 신경 · 얕은샅공간 · 깊은샅공간"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "궁둥항문오목의 혈관과 신경 · 음경 · 깊은샅공간 (deep perineal pouch)"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "얕은샅공간 (superficial perineal) · 깊은샅공간 (deep perineal pouch) · 얕은샅공간2 · 깊은샅공간2"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "얕은샅공간2 · 피부벗기기 · 궁둥항문오목의 혈관과 신경"
    }
   ]
  },
  {
   ...
   "refs": [
    {
     "file": "13차시(0929) 김홍태pf.pdf〔과거 학기 파일명 — 2026 담당·회차 근거 아님〕",
     "page": null,
     "section": "궁둥항문오목 (ischioanal fossa) · 깊은샅공간 (deep perineal pouch) · 얕은샅공간 (superficial perine)"
    },
    {
     "file": "2026학년도 2학기 수업계획서(실습계획표) — 12회차",
     "page": null,
 ...
 "guides": [
   ...
   "mnemonics": [
    {
     ...
     "full": "가로막신경 = C3·C4·C5",
     "note": "그래서 가로막·심장막 자극이 어깨(C3–C5 피부분절)로 간다"
    },
    {
     "key": "앞은 가로막 뒤는 미주",
     "full": "허파뿌리 앞=가로막신경 / 뒤=미주신경",
     "note": "세로칸에서 두 신경을 가르는 유일한 기준 — 태깅 단골"
    },
    {
     "key": "VAB — 정동기",
     "full": "허파뿌리 앞→뒤: 허파정맥 → 허파동맥 → 기관지",
     "note": "좌우 공통. 위→아래만 좌우가 다르다(오른쪽 기관지가 위, 왼쪽 동맥이 위)"
    },
    {
     "key": "복장뼈각 = 4·5",
     "full": "둘째 갈비연골 · T4/T5 · 기관갈림 · 대동맥활 시작과 끝 · 위/아래세로칸 경계",
     "note": "높이를 묻는 문제는 거의 다 이 한 줄로 풀린다"
    },
    {
     "key": "가슴막 8·10·12 / 허파 6·8·10",
     "full": "빗장중간선 · 중간겨드랑선 · 척주옆선",
     "note": "가슴막이 항상 두 갈비 아래 — 그 차이가 갈비가로막오목이다"
    },
    {
     "key": "가로굴은 동맥 뒤 정맥 앞",
     "full": "가로굴 앞벽=대동맥+허파동맥줄기 / 뒤벽=위대정맥+왼심방",
     "note": "빗굴은 왼심방 뒤 막다른 골목 — 둘을 바꿔 쓰지 말 것"
    },
    {
     "key": "위세로칸 앞→뒤 '샘–정–동–기–식–관'",
     "full": "가슴샘 → 정맥 → 동맥 → 기관 → 식도 → 가슴관",
     "note": "얕은 것부터 벗겨 나가는 실습 순서 그대로"
    },
    {
     "key": "가쪽만 연다",
     "full": "관자·깨물·안쪽날개=닫기 / 가쪽날개=열기",
     "note": "씹기근육 4개는 전부 V3 지배 — 신경은 같고 작용만 하나가 반대"
    },
    {
     "key": "위턱동맥 1·2·3 = 구멍·근육·우묵",
     "full": "1부 뼈구멍으로 / 2부 씹기근육으로 / 3부 날개입천장우묵으로",
     "note": "중간뇌막동맥은 1부, 나비입천장동맥은 3부"
    },
    {
     "key": "고실끈은 VII이 V3에 얹힌 것",
     "full": "혀 앞 2/3 미각 + 턱밑·혀밑샘 = 얼굴신경(VII)",
     "note": "혀신경(V3)은 같은 자리의 '일반감각' 담당 — 길만 빌려준다"
    },
    {
     "key": "오른쪽이 70% 우세",
     "full": "뒤심실사이가지가 오른심장동맥에서 나오면 right dominance",
  ...
  },
  {
   ...
   "session": 7,
   "title": "Tagging 1 D-1 최종 점검",
   "subtitle": "새 내용 없음 · 퀴즈판 인출 드릴 5 · 답안 표기 교정 · 시험장 운영 프로토콜",
   "sections": [
   ...
   "figs": [
    "diag-gluteal-foramina-quiz.svg",
    "diag-popliteal-fossa-quiz.svg",
    "diag-scapular-spaces-quiz.svg",
    "diag-suboccipital-quiz.svg",
    "tree-s07-bundle-quiz.svg"
   ],
   "mnemonics": [
    {
     "key": "약자는 마침표까지가 한 단어",
     "full": "a. v. n. m. lig. sup. inf. ant. post. med. lat. — 마침표를 빼면 인정되지 않을 수 있다",
     "note": "허용 목록 밖 약자(art., ner., musc.)는 아예 쓰지 않는다. 확신이 없으면 풀어 쓴다"
    },
    {
     "key": "방향어가 답의 절반",
     "full": "'지나간다'가 아니라 '앞으로 지나간다' — ant. post. med. lat. sup. inf. 를 빼면 반만 쓴 답",
     "note": "좌우·앞뒤를 묻는 문항(0154 · 0159 · 0388)에서 방향어 없는 답은 점수가 안 붙는다"
    },
    {
     "key": "위는 하나, 아래는 여럿",
     "full": "궁둥구멍근 위 = 위볼기신경·위볼기동정맥뿐 / 아래 = 궁둥신경·아래볼기·음부·뒤넙다리피부신경",
     "note": "'위/아래 중 어디로 나오나'는 위에 무엇이 없는지로 답하면 빠르다"
    },
    {
     "key": "오금은 뒤에서, 갈비사이는 위에서",
     "full": "오금 얕은→깊은 = 신경·정맥·동맥 / 갈비사이고랑 위→아래 = 정맥·동맥·신경",
     "note": "둘 다 N-V-A 세 글자지만 세는 방향이 반대다 — 순서 문항의 단골 함정"
    },
    {
     "key": "귀밑샘은 얼-뒤-바",
     "full": "얕은→깊은: 얼굴신경 → 뒤턱정맥 → 바깥목동맥",
     "note": "귀밑샘 절제에서 얼굴신경이 가장 먼저 걸리는 이유가 이 순서"
    },
    {
     "key": "오른쪽은 짧고 왼쪽은 길다",
     "full": "되돌이후두신경 — 오른쪽은 빗장밑동맥, 왼쪽은 대동맥활을 감아 돈다",
     "note": "왼쪽이 길어 종격동 병변·심장수술에서 잘 다친다"
    },
    {
     "key": "순서 문항은 전부 아니면 전무",
     "full": "0368 오금 깊이 · 0389 발목굴 앞→뒤 · 0159 허파뿌리 배열",
     "note": "다섯 이름을 다 맞혀도 순서가 어긋나면 오답으로 본다 — 쓰기 전에 방향을 먼저 정한다"
    },
    {
     "key": "모르면 한 단계 위로",
     "full": "이름이 안 나오면 '넙다리신경의 가지'·'V3 의 가지'처럼 상위 계보라도 쓴다",
     "note": "빈칸은 0점이지만 상위 개념은 부분점수 여지가 있다 — 절대 비우고 나오지 않는다"
    }
   ],
   "scanCount": 0
  },
  {
   ...
   "figs": [
    "tree-s09-bundle-labeled.svg",
    "tree-s09-nerve-labeled.svg",
    "tree-s09-vessel-labeled.svg"
   ],
   "mnemonics": [
    {
     "key": "작은가슴근이 전부 정한다",
     "full": "겨드랑동맥 1·2·3부 · 림프절 level III·II·I · 다발 이름(가쪽·안쪽·뒤)",
     "note": "근육 하나가 동맥·림프절·신경의 좌표계를 동시에 준다"
    },
    {
     "key": "가지 수도 1–2–3",
     "full": "1부 1개(위가슴) · 2부 2개(가슴봉우리·가쪽가슴) · 3부 3개(어깨밑·뒤/앞위팔휘돌이)",
     "note": "부 번호 = 가지 수 — 세는 순서가 곧 답"
    },
    {
     "key": "ABCD",
     "full": "가슴봉우리동맥 네 가지 — Acromial · Branch to clavicle · Deltoid · Pectoral",
     "note": "2부의 첫 가지"
    },
    {
     "key": "뿌리–줄기–갈래–다발–가지",
     "full": "Roots–Trunks–Divisions–Cords–Branches (Real Texans Drink Cold Beer)",
     "note": "다섯 단계 · 갈래는 첫째갈비뼈 뒤라 실습에서 안 보인다"
    },
    {
     "key": "정–동–기(VAB)",
     "full": "허파뿌리 앞→뒤 = 허파정맥–허파동맥–기관지 · 좌우 공통",
     "note": "위→아래만 좌우가 다르다"
    },
    {
     "key": "오른쪽은 기관지가 위, 왼쪽은 동맥이 위",
     "full": "오른위엽기관지 = 동맥위기관지(eparterial) / 왼허파동맥은 대동맥활을 넘는다",
     "note": "차이의 원인은 대동맥활 하나뿐"
    },
    {
     "key": "오른쪽은 짧고 굵고 곧다",
     "full": "오른주기관지 — 이물질이 오른아래엽으로 간다",
     "note": "왼쪽은 길고 가늘고 눕는다(대동맥활을 피해)"
    },
    {
     "key": "허파 6·8·10 / 가슴막 8·10·12",
     "full": "빗장중간선 · 중간겨드랑선 · 척주옆선 — 가슴막이 항상 두 갈비뼈 아래",
     "note": "그 차이가 갈비가로막오목 = 천자 자리"
    },
    {
     "key": "8-10-12에 3-4-5",
     "full": "대정맥구멍 T8(vena cava) · 식도구멍 T10(esophagus) · 대동맥구멍 T12(aortic)",
     "note": "글자 수가 하나씩 는다"
    },
    {
     "key": "VAN, 위에서 아래로",
     "full": "갈비사이 정맥–동맥–신경 · 신경이 맨 아래라 가장 노출된다",
     "note": "바늘은 아래 갈비뼈의 위모서리로"
    },
    {
     "key": "왼쪽이 앞, 오른쪽이 뒤",
     "full": "왼미주신경 → 앞미주줄기 / 오른미주신경 → 뒤미주줄기",
     "note": "위가 돌아가며 끌려온 결과"
    },
    {
     "key": "오른쪽은 빗장밑, 왼쪽은 대동맥활",
     "full": "되돌이후두신경이 감아 도는 구조 — 왼쪽만 가슴으로 내려온다",
     "note": "그래서 폐암·세로칸 병변에 쉰 목소리"
    }
   ],
   "scanCount": 0
  },
  {
   ...
   "figs": [
    "tree-s10-bundle-labeled.svg",
    "tree-s10-nerve-labeled.svg",
    "tree-s10-vessel-labeled.svg"
   ],
   "mnemonics": [
    {
     "key": "팔오금은 가쪽에서 안쪽으로 TAN",
     "full": "Tendon(위팔두갈래근 힘줄) – Artery(위팔동맥) – Nerve(정중신경)",
     "note": "혈압계 커프가 눌러 소리를 내는 것이 가운데 A다"
    },
    {
     "key": "손목굴은 9+1 = 10",
     "full": "얕은손가락굽힘근 4 + 깊은손가락굽힘근 4 + 긴엄지굽힘근 1 = 힘줄 9개, 여기에 정중신경 1개",
     "note": "자신경·자동맥·노동맥·긴손바닥근 힘줄은 안 지난다"
    },
    {
     "key": "손목굴 네 기둥 — 배·콩 / 마름·갈고리",
     "full": "몸쪽 손배뼈·콩알뼈 · 먼쪽 큰마름뼈·갈고리뼈갈고리",
     "note": "가쪽이 배와 마름, 안쪽이 콩과 갈고리"
    },
    {
     "key": "정중신경은 엄지 3 + 벌레근 2",
     "full": "되돌이가지 = 엄지두덩 3근(짧은엄지벌림·짧은엄지굽힘 얕은갈래·엄지맞섬), 그리고 벌레근 1·2",
     "note": "나머지 손의 근육은 전부 자신경 깊은가지"
    },
    {
     "key": "LOAF",
     "full": "정중신경이 맡는 손의 근육 — Lumbricals 1·2 · Opponens pollicis · Abductor pollicis brevis · Flexor pollicis brevis(얕은갈래)",
     "note": "이 넷만 빼면 다 자신경이다"
    },
    {
     "key": "얕은활은 자, 깊은활은 노",
     "full": "얕은손바닥동맥활 = 자동맥이 주인 · 깊은손바닥동맥활 = 노동맥이 주인",
     "note": "그래서 노동맥 채혈 전에 Allen 검사로 자동맥의 활을 확인한다"
    },
    {
     "key": "얕은활이 먼쪽, 깊은활이 몸쪽",
     "full": "얕은활은 엄지 편 손의 자쪽 선까지, 깊은활은 그보다 한 손가락 몸쪽",
     "note": "이름과 위치가 반대로 느껴지는 지점"
    },
    {
     "key": "자신경은 콩과 갈고리 사이로",
     "full": "자신경굴(Guyon canal) — 콩알뼈와 갈고리뼈갈고리 사이 · 굽힘근지지띠 **위**",
     "note": "손목굴은 지지띠 아래, 자신경굴은 지지띠 위"
    },
    {
     "key": "배근육은 밖에서 안으로 바깥–속–가로",
     "full": "배바깥빗근(아래안쪽) · 배속빗근(위안쪽) · 배가로근(수평)",
     "note": "섬유 방향이 손을 주머니에 넣는 방향 → 그 반대 → 수평"
    },
    {
     "key": "정삭 세 막은 배벽 세 근육에서",
     "full": "바깥정삭근막 ← 배바깥빗근 · 고환올림근(막) ← 배속빗근 · 속정삭근막 ← 배가로근막",
     "note": "순서가 층 순서 그대로다"
    },
    {
     "key": "속은 가쪽, 직접은 안쪽",
     "full": "속고샅탈장은 아래배벽동맥 **가쪽**(깊은고샅구멍), 직접고샅탈장은 **안쪽**(Hesselbach 삼각)",
     "note": "동맥 하나가 두 탈장을 가른다"
    },
    {
     "key": "활꼴선 위아래가 다르다",
     "full": "활꼴선 위 — 뒤엽 있음(배속빗근 뒤판 + 배가로근), 아래 — 뒤엽 없음(전부 앞으로) → 배가로근막이 뒤를 맡는다",
     "note": "아래배벽동맥이 배곧은근집에 들어오는 자리이기도 하다"
    },
    {
     "key": "왼쪽 정계정맥류",
     "full": "왼고환정맥은 왼콩팥정맥으로 **직각** 유입 · 오른쪽은 아래대정맥으로 비스듬히",
     "note": "그래서 정계정맥류는 왼쪽에 많고, 갑자기 생기면 콩팥종양을 의심한다"
    }
   ],
   "scanCount": 0
  },
