...
next_goal: "실험1′ 종결(보상지수 축 = 이득 없음, 확정). 다음은 '재조합'이 아니라 '새 관측'을 더하는 갈래 — 실험2 P파 분할(LUDB) 또는 실험10 유도 ablation. 사전등록 결정규칙(CI 반폭<0.03에서 0 포함 → Phase2 물리특징 갈래 종료)에 따름"
...
**Icentia11k 580환자 · 467,885비트 · 테스트 203명(이소성 보유 90명) · 단일유도 250 Hz**
